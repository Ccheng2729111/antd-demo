...
import SortableTree, {getNodeAtPath,defaultGetNodeKey, addNodeUnderParent, removeNodeAtPath, changeNodeAtPath, NodeRendererCustom } from 'react-sortable-tree';
                ...
                <SortableTree
                    ...
                    generateNodeProps={rowInfo => ({
                        buttons: [
                            ...
                            <Icon type="plus-circle-o"  onClick={this.addChilderNode.bind(this,rowInfo)} style={{fontSize:20,background:'#fff',cursor:'pointer',position:'absolute',left:0,top:40}}/>
                        ]
                    })}
                />
            </div>
