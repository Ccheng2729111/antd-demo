!function(root, factory) {
...
}(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_25__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_27__, __WEBPACK_EXTERNAL_MODULE_28__, __WEBPACK_EXTERNAL_MODULE_29__) {
    /******/
    ...
    function(module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.SortableTreeWithoutDndContext = exports.NodeRendererCustom = void 0;
        var _defaultHandlers = __webpack_require__(7);
        ...
        var _nodeRendererCustom = __webpack_require__(10), _nodeRendererCustom2 = _interopRequireDefault(_nodeRendererCustom), _reactSortableTree = __webpack_require__(12), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree);
        exports.NodeRendererCustom = _nodeRendererCustom2.default, /**
	                                                            * @author cyc
	                                                            * add at 2017/6/34
	                                                            */
	...
	*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        function createClassReg(className) {
            return new RegExp("\\b" + className + "\\b");
        }
        function inContainer(className, node) {
            for (var _document = document, documentElement = _document.documentElement; node && node != documentElement; ) {
                if (createClassReg(className).test(node.className)) return !0;
        ...
        var _createClass = function() {
            ...
            return target;
        }, _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _browserUtils = __webpack_require__(6), _nodeRendererDefault = __webpack_require__(9), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1);
        ...
        var NodeRendererCustom = function(_Component) {
            function NodeRendererCustom(props) {
                _classCallCheck(this, NodeRendererCustom);
                var _this = _possibleConstructorReturn(this, (NodeRendererCustom.__proto__ || Object.getPrototypeOf(NodeRendererCustom)).call(this, props));
                return _this.state = {
                    isEdit: !1,
                    width: "",
                    value: ""
                }, _this.saveInputVal = _this.saveInputVal.bind(_this), _this.inputHandler = _this.inputHandler.bind(_this), 
                _this.keyupHandler = _this.keyupHandler.bind(_this), _this.dblClickHandler = _this.dblClickHandler.bind(_this), 
                _this;
            }
            return _inherits(NodeRendererCustom, _Component), _createClass(NodeRendererCustom, [ {
                key: "saveInputVal",
                value: function() {
                    var _props = this.props, node = _props.node, path = _props.path, treeIndex = _props.treeIndex, onInputSave = _props.onInputSave, value = this.state.value;
                    onInputSave({
                        node: node,
                        path: path,
                        treeIndex: treeIndex,
                ...
                key: "keyupHandler",
                value: function(e) {
                    13 == e.keyCode && this.saveInputVal();
                }
            }, {
                key: "dblClickHandler",
                value: function(e) {
                    var container, width, containerStyle, contentStyle, node = this.props.node, content = this.content;
                    "INPUT" == e.target.nodeName || inContainer(styles.rowToolbar, e.target) || (content ? (container = content.parentNode, 
                    contentStyle = getComputedStyle(content), containerStyle = getComputedStyle(container), 
                    width = container.clientWidth - parseInt(containerStyle.paddingLeft) - parseInt(containerStyle.paddingRight) - parseInt(contentStyle.paddingLeft) - parseInt(contentStyle.paddingRight)) : width = "", 
                    this.setState({
                        isEdit: !0,
                        value: node.title,
                        width: width
                ...
                value: function(prevProps, prevState) {
                    this.state.isEdit && !prevState.isEdit && this.input && this.input.focus();
                }
            }, {
                key: "render",
                value: function() {
                    function _connectDragSource(component) {
                        return canDrag ? connectDragSource(component) : component;
                    }
                    var _this2 = this, _props2 = this.props, scaffoldBlockPxWidth = _props2.scaffoldBlockPxWidth, toggleChildrenVisibility = _props2.toggleChildrenVisibility, connectDragPreview = (_props2.onInputSave, 
                    _props2.connectDragPreview), connectDragSource = _props2.connectDragSource, isDragging = _props2.isDragging, canDrop = _props2.canDrop, canDrag = _props2.canDrag, node = _props2.node, draggedNode = _props2.draggedNode, path = _props2.path, treeIndex = _props2.treeIndex, isSearchMatch = _props2.isSearchMatch, isSearchFocus = _props2.isSearchFocus, buttons = _props2.buttons, className = _props2.className, style = _props2.style, didDrop = _props2.didDrop, otherProps = (_props2.isOver, 
                    _props2.parentNode, _props2.endDrag, _props2.startDrag, _objectWithoutProperties(_props2, [ "scaffoldBlockPxWidth", "toggleChildrenVisibility", "onInputSave", "connectDragPreview", "connectDragSource", "isDragging", "canDrop", "canDrag", "node", "draggedNode", "path", "treeIndex", "isSearchMatch", "isSearchFocus", "buttons", "className", "style", "didDrop", "isOver", "parentNode", "endDrag", "startDrag" ])), _state = this.state, isEdit = _state.isEdit, value = _state.value, width = _state.width, handle = void 0;
                    ...
                    }, _connectDragSource(_react2.default.createElement("div", {
                        className: styles.rowContents + " cyc-rst__rowContents" + (canDrag ? "" : " " + styles.rowContentsDragDisabled),
                        onDoubleClick: this.dblClickHandler
                    }, _react2.default.createElement("div", {
                        className: styles.rowLabel,
                        ref: function(o) {
                            return _this2.content = o;
                        }
                    }, isEdit ? _react2.default.createElement("input", {
                        className: "cyc-rst__rowInput",
                        value: value,
                        ref: function(o) {
                    ...
                    }, "function" == typeof node.renderTitle ? node.renderTitle({
                        node: node,
                        path: path,
                        treeIndex: treeIndex
                    }) : node.title)), _react2.default.createElement("div", {
                        className: styles.rowToolbar + " cyc-rst__rowToolbar"
        ...
        NodeRendererCustom.defaultProps = {
            isSearchMatch: !1,
            isSearchFocus: !1,
            canDrag: !1,
        ...
        }, exports.default = NodeRendererCustom;
    }, /* 11 */
    /***/
    function(module, exports, __webpack_require__) {
        "use strict";
        ...
        var _createClass = function() {
            ...
            return target;
        }, _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _browserUtils = __webpack_require__(6), _nodeRendererDefault = __webpack_require__(9), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), styles = _nodeRendererDefault2.default;
        // Add extra classes in browsers that don't support flex
        _browserUtils.getIEVersion < 10 && (styles = _extends({}, _nodeRendererDefault2.default, {
            row: styles.row + " " + styles.row_NoFlex,
            rowContents: styles.rowContents + " " + styles.rowContents_NoFlex,
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _reactVirtualized = __webpack_require__(29), _lodash = __webpack_require__(25), _lodash2 = _interopRequireDefault(_lodash), _reactDndScrollzone = __webpack_require__(28), _reactDndScrollzone2 = _interopRequireDefault(_reactDndScrollzone);
        __webpack_require__(21);
        var _treeNode = __webpack_require__(13), _treeNode2 = _interopRequireDefault(_treeNode), _nodeRendererDefault = __webpack_require__(11), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), _memoizedTreeDataUtils = __webpack_require__(8), _genericUtils = __webpack_require__(15), _defaultHandlers = __webpack_require__(7), _dragAndDropUtils = __webpack_require__(14), _reactSortableTree = __webpack_require__(23), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree), dndTypeCounter = 1, ReactSortableTree = function(_Component) {
            ...
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function(_ref9, listIndex, style, getPrevRow, matchKeys) {
                    ...
                    return _react2.default.createElement(TreeNodeRenderer, {
                        ...
                        onInputSave: this.props.onInputSave,
                        scaffoldBlockPxWidth: scaffoldBlockPxWidth
                    }, nodeProps)));
                }
            }, {
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _treeNode = __webpack_require__(24), _treeNode2 = _interopRequireDefault(_treeNode), TreeNode = function(_Component) {
            function TreeNode() {
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _reactDnd = __webpack_require__(26), _reactDndHtml5Backend = __webpack_require__(27), _reactDndHtml5Backend2 = _interopRequireDefault(_reactDndHtml5Backend), _treeDataUtils = __webpack_require__(1), _memoizedTreeDataUtils = __webpack_require__(8), nodeDragSource = {
    ...
    function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__(2)(void 0), // imports
        // module
        exports.push([ module.id, ".cyc-rst__rowContents{border:2px solid #3189c5;box-shadow:none}.cyc-rst__rowToolbar{position:absolute;top:-11px;right:-11px}.cyc-rst__rowInput{outline:0;border:none}", "" ]);
    }, /* 18 */
    /***/
    function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__(2)(void 0), // imports
